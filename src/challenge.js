...
(function (module) {
    ...
    var Challenge = function () {
        ...
        self._app.use('/js', express.static(__dirname + '/views/dist/js')); // serve static files
        self._app.use('/css', express.static(__dirname + '/views/dist/css')); // serve static files
        ...
        var root = __dirname + '/views/dist'
        self._app.use(express.static(root))
        self._app.use(fallback('index.html', { root: root }))
